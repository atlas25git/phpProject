	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					<h4 class="stext-301 cl0 p-b-30">
						Give our stores a visit!
					</h4>

					<p class="stext-107 cl7 size-201">
						Early access to over 100 pre-relase drafts of best time sellers.
					</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | atlas25 </a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
